...
db.connect((err) => {
  ...
  console.log('Conectado a la base de datos pokedeck');
});
...
app.post('/api/registro', (req, res) => {
  ...
  db.query(verificarUsuario, [email], (err, results) => {
    ...
    const insertarUsuario = 'INSERT INTO usuarios (nombre, email, password) VALUES (?, ?, ?)';
    db.query(insertarUsuario, [nombre, email, password], (err, result) => {
      if (err) {
